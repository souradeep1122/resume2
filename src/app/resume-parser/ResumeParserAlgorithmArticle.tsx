  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the Re.sume
      ...
      <Paragraph>
        And that is everything about the Re.sume parser algorithm :)
      </Paragraph>
      <Paragraph>
        Written by <Link href="https://github.com/souradeep1122">Souradeep</Link> on
        Feb 2025
      </Paragraph>
    </article>
  );
