...
const FEATURES = [
  {
    src: featureFreeSrc,
    title: "Free Forever",
    text: "Re.sume is created with the belief that everyone should have free and easy access to a modern professional resume design",
  },
  {
    src: featureUSSrc,
    title: "Professional Best Practices",
    text: "Re.sume has built-in best practices for the Indian job market and works well with top ATS platforms such as Naukri RMS and Talenture.",
  },
  {
    src: featurePrivacySrc,
    title: "Privacy Focus",
    text: "Re.sume stores data locally in your browser so only you have access to your data and with complete control",
  },
  {
    ...
    text: (
      <>
        Re.sume is an open-source project, and its source code can be viewed
        by anyone on our{" "}
