...
const TESTIMONIALS = [
  {
    ...
    quote:
      "Students often make silly mistakes on their resume by using inconsistent bullet points or font sizes. Re.sume’s auto format feature is a great help to ensure consistent format.",
    name: "Rehan",
    title: "UEM Student",
  },
  {
    ...
    quote:
      "I used Re.sume during my last job search and was invited to interview at top tech companies such as Google and Amazon thanks to its slick yet professional resume design.",
    name: "Abhijeet",
    title: "Student",
  },
  {
    ...
    quote:
      "Creating a professional resume on Re.sume is so smooth and easy! It saves me so much time and headache to not deal with google doc template.",
    name: "Sneha",
    title: "UEM Student",
  },
];
